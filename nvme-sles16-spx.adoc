...
.NVMe/FC
--
Os exemplos de saída a seguir mostram um namespace hospedado em um controlador ONTAP de dois nós para sistemas AFF, FAS, ASA ou ASA r2 com NVMe/FC.

.Exibir exemplo de saída para AFF, FAS ou ASA
[%collapsible]
=====
[listing, subs="+quotes"]
----
...
----
=====
.Mostrar exemplo de saída para ASA r2
[%collapsible]
=====
[listing, subs="+quotes"]
----
...
.NVMe/TCP
--
Os exemplos de saída a seguir mostram um namespace hospedado em um controlador ONTAP de dois nós para sistemas AFF, FAS, ASA ou ASA r2 com NVMe/TCP.
...
----
====
.. Exporte a chave PSK TLS do chaveiro do kernel. Isso garante que a chave persista durante a reinicialização do host:
+
[source, cli]
----
