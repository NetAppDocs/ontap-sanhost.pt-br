...
Se os problemas persistirem, reúna os seguintes arquivos e resultados de comando e entre em contato. link:mysupport.netapp.com["Suporte à NetApp"^] para triagem adicional:
