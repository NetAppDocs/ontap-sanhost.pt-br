...
summary: Instale os utilitários de host Linux em um host Oracle Linux 10 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configurar o Oracle Linux 10 para FCP e iSCSI com storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
O software Linux Host Utilities fornece ferramentas de gerenciamento e diagnóstico para hosts Linux conectados ao storage ONTAP. Ao instalar o Linux Host Utilities em um host Oracle Linux 10, você pode usar o Host Utilities para ajudar a gerenciar as operações dos protocolos FCP e iSCSI com LUNs ONTAP.
...
Você pode usar o recurso de multipathing com o Oracle Linux 10 para gerenciar LUNs do ONTAP.
