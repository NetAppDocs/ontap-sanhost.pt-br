...
summary: Instale os utilitários de host Linux em um host Oracle Linux 10.x para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configurar o Oracle Linux 10.x para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
link:hu_luhu_71.html["Instalar o Linux Host Utilities 7.1 para armazenamento ONTAP"].
...
Você pode usar o recurso de multipathing com o Oracle Linux 10.x para gerenciar LUNs do ONTAP.
