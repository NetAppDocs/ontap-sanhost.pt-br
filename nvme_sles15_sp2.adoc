...
[role="lead"]
O NVMe/FC é compatível com o ONTAP 9.6 e superior com o SLES15 SP2. O host SLES15 SP2 pode executar o tráfego NVMe/FC e FCP nas mesmas portas do adaptador do iniciador de fibra. Consulte o link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] para obter uma lista de controladores e adaptadores FC compatíveis.
...
== Habilite o NVMe/FC em SLES15 SP2

. Atualize para a versão recomendada do kernel SLES15 SP2 MU.
...
----
. No host SLES15 SP2, verifique a string NQN do host em `/etc/nvme/hostnqn` e verifique se ela corresponde à string NQN do host para o subsistema correspondente no array ONTAP. Por exemplo:
+
[listing]
----
