...
summary: Instale o Linux Host Utilities em um host Rocky Linux 8.10 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o Rocky Linux 8.x para FCP e iSCSI com armazenamento ONTAP.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar o recurso de multipathing com o Rocky Linux 8.x para gerenciar LUNs do ONTAP .
