...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 9,1 (RHCK), use o link:hu_rhel_91.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 9,1.
