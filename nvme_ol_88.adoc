...
* Não há suporte para NVMe-of. Portanto, não há suporte a utilitário de host para NVMe-of em um host OL 8,8. Você pode usar o plug-in NetApp incluído no pacote nativo `nvme-cli` para todos os transportes NVMe-of.
