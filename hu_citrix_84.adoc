...
summary: Configure o Citrix Hypervisor 8.4 para multicaminhos e com parâmetros e configurações específicos para operações de protocolo FCP e iSCSI com armazenamento ONTAP . 
---
