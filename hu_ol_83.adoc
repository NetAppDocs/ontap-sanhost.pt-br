...
NOTE: Para configurar o Oracle Linux 8,3 Red Hat Enterprise Kernel (RHCK), use o link:hu_rhel_83.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,3.



== Problemas conhecidos

Não há problemas conhecidos para o Oracle Linux 8,3 com a versão ONTAP.


NOTE: Para problemas conhecidos do Oracle Linux (kernel compatível com Red Hat), consulte a link:hu_rhel_83.html#known-problems-and-limitations["problemas conhecidos"] seção na documentação de lançamento do Red Hat Enterprise Linux correspondente.
