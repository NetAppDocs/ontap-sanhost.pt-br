...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 7,4 (RHCK), use o link:hu_rhel_74.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 7,4.
