...
summary: Instale os utilitários do host Linux em um host RHEL 10.x para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP . 
---
= Configurar RHEL 10.x para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
É possível usar o recurso de multipathing com o RHEL 10.x para gerenciar LUNs do ONTAP .
