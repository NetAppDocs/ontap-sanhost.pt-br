...
summary: Instale o Linux Host Utilities em um host Rocky Linux 9.0 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configurar o Rocky Linux 9.0 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com o Rocky Linux 9.0 para gerenciar LUNs ONTAP.
