...
No RHEL 10.0, a iopolicy padrão é round-robin, mas queue-depth está disponível como uma opção configurável. Se você estiver usando o RHEL 10.0, pode alterar a iopolicy para queue-depth modificando o arquivo de regras do udev.
