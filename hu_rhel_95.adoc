...
summary: Instale os Utilitários de host Linux em um host RHEL 9,5 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o RHEL 9,5 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
== Etapa 2: Confirme a configuração multipath do seu host

Você pode usar multipathing com RHEL 9,5 para gerenciar LUNs ONTAP.
