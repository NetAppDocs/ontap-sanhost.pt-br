...
.Antes de começar
Sua configuração suporta inicialização SAN. Consulte link:https://imt.netapp.com/matrix/#welcome["Ferramenta de Matriz de interoperabilidade"^]para verificar se o seu SO, HBA, firmware HBA e o BIOS de inicialização HBA e a versão ONTAP são suportados.
