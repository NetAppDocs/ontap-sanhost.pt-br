...
NOTE: Não devem ser necessários mais de quatro caminhos para um único LUN. Mais de oito caminhos podem causar problemas de caminho durante falhas de storage.
