...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 8,9 (RHCK), use o link:hu_rhel_89.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,9.
