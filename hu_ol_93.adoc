...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 9,3 (RHCK), use o link:hu_rhel_93.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 9,3.
