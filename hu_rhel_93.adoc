...
summary: Instale os Utilitários de host Linux em um host RHEL 9,3 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o RHEL 9,3 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com RHEL 9,3 para gerenciar LUNs ONTAP.
...
O RHEL 9,3 com a versão de armazenamento ONTAP tem os seguintes problemas conhecidos:
