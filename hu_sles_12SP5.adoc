...
summary: Instale os utilitários de host Linux em um SUSE Linux Enterprise Server 12 SP5 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
