...
summary: Descreve como usar o Oracle Linux 6,7 com ONTAP 
---
= Use o Oracle Linux 6,7 com ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Você pode usar as configurações de host SAN ONTAP para configurar o Oracle Linux 6,7 com ONTAP como destino.
...
Se você decidir usar a inicialização de SAN, ele deve ser suportado por sua configuração. Você pode usar o https://mysupport.netapp.com/matrix/imt.jsp?components=74908;74907;71545;71546;&solution=1&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"^] para verificar se o seu sistema operacional, HBA, HBA firmware e o BIOS de inicialização HBA e a versão ONTAP são suportados.
...
Para o Oracle Linux 6,7 o arquivo /etc/multipath.conf deve existir, mas você não precisa fazer alterações específicas no arquivo. O Oracle Linux 6,7 é compilado com todas as configurações necessárias para reconhecer e gerenciar corretamente LUNs ONTAP. Para ativar o ALUA Handler, execute as seguintes etapas:
...
O sistema operacional Oracle Linux 6,7 é compilado para reconhecer LUNs ONTAP e definir automaticamente todos os parâmetros de configuração corretamente.
...
NOTE: Para configurar o Oracle Linux 6,7 Red Hat Enterprise Kernel (RHCK), use o link:hu_rhel_67.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 6,7.



== Problemas conhecidos

Não há problemas conhecidos para o Oracle Linux 6,7 com a versão ONTAP.


NOTE: Para problemas conhecidos do Oracle Linux (kernel compatível com Red Hat), consulte o link:hu_rhel_67.html#known-problems-and-limitations["problemas conhecidos"] para Red Hat Enterprise Linux (RHEL) 6,7.
