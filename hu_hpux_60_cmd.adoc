...
[role="lead"]
Você pode usar a referência de exemplo de comando HP-UX Unified Host Utilities 6,0 para uma validação completa da configuração de armazenamento NetApp usando a ferramenta de utilitários host.
