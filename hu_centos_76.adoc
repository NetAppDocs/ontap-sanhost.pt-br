...
[role="lead"]
Você pode usar as configurações de host SAN ONTAP para configurar o CentOS 7,6 com ONTAP como destino.
...
A versão CentOS 7,6 com ONTAP tem os seguintes problemas conhecidos:
