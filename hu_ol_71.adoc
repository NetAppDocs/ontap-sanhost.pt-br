...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 7,1 (RHCK), use o link:hu_rhel_71.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 7,1.
