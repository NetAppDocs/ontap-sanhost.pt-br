...
Aprenda como configurar hosts NVMe over Fabrics (NVMe-oF) para Rocky Linux 9.1. Para obter mais informações sobre suporte e funcionalidades, consulte link:nvme-rockylinux-overview.html["Suporte e recursos do Rocky Linux ONTAP"].
