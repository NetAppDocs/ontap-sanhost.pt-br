...
Aprenda a configurar hosts NVMe sobre Fabrics (NVMe-oF) para o Rocky Linux 9.1.  Para obter mais suporte e informações sobre recursos, consultelink:hu-nvme-index.html["Visão geral do NVME-oF"^] .
