...
summary: Instale os utilitários do host Linux em um host Ubuntu 26.04 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o Ubuntu 26.04 para FCP e iSCSI com o armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar o recurso de multipathing com o Ubuntu 26.04 para gerenciar LUNs do ONTAP.
