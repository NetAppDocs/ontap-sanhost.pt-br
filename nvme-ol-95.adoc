...
.Passos
. Verifique as seguintes configurações de NVMe/FC no host Oracle Linux 9,5:
+
.. Verifique se "multipath" está definido:
+
[source, cli]
----
...
----
+
O valor  `Y` verifica se o parâmetro multipath está definido.
