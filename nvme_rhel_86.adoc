...
--
O driver nativo da caixa de entrada `qla2xxx` incluído no kernel RHEL 8,6 tem as correções upstream mais recentes que são essenciais para o suporte ao ONTAP.
