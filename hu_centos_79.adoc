...
summary: Instale o Linux Host Utilities em um host CentOS 7.9 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP . 
---
= Configurar o CentOS 7.9 para FCP e iSCSI para armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
O software Utilitários de host Linux fornece ferramentas de gerenciamento e diagnóstico para hosts Linux que estão conetados ao storage ONTAP. Ao instalar o Linux Host Utilities em um host CentOS 7.9, você pode usá-lo para ajudar a gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP.
...
Você pode usar multipathing com o CentOS 7.9 para gerenciar LUNs ONTAP.
...
O host CentOS 7.9 com armazenamento ONTAP tem os seguintes problemas conhecidos:
