...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 7,2 (RHCK), use o link:hu_rhel_72.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 7,2.
