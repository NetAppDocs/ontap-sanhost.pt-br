...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 6,5 (RHCK), use o link:hu_rhel_65.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 6,5.
...
NOTE: Para problemas conhecidos do RHCK do Oracle Linux, consulte o link:hu_rhel_65.html#known-problems-and-limitations["problemas conhecidos"] para RHEL 6,5.
