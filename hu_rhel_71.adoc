...
summary: Instale o Linux Host Utilities em um host RHEL 7.1 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o RHEL 7,1 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com RHEL 7,1 para gerenciar LUNs ONTAP.
...
O RHEL 7,1 com a versão de armazenamento ONTAP tem os seguintes problemas conhecidos:
