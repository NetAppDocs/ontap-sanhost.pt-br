...
Aprenda a configurar hosts NVMe sobre Fabrics (NVMe-oF) para o Rocky Linux 8.5.  Para obter mais informações sobre suporte e recursos, consultelink:hu-nvme-index.html["Visão geral do NVME-oF"^] .
