...
summary: Instale o Linux Host Utilities em um host Rocky Linux 8.7 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configurar o Rocky Linux 8.7 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com o Rocky Linux 8.7 para gerenciar LUNs ONTAP.
