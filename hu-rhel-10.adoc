...
summary: Instale os utilitários do host Linux em um host RHEL 10 para gerenciar as operações dos protocolos FCP e iSCSI com LUNs ONTAP . 
---
= Configurar o RHEL 10 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar o recurso de multipathing com o RHEL 10 para gerenciar LUNs do ONTAP .
