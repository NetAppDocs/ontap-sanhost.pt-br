...
* Não há suporte para NVMe/FC e, como consequência, não há suporte para Linux Unified Host Utilities (LUHU) para NVMe/FC no Oracle Linux 8,1. Use a saída do comando ONTAP disponível como parte do plug-in NetApp incluído no nvme-cli nativo.
