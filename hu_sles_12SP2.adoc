...
summary: Instale o Linux Host Utilities em um SUSE Linux Enterprise Server 12 SP2 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o SUSE Linux Enterprise Server 12 SP2 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com o SUSE Linux Enterprise Server 12 SP2 para gerenciar LUNs ONTAP.
