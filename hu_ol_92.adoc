...
NOTE: Para configurar o Oracle Linux 9,2 Red Hat Enterprise Kernel (RHCK), use o link:hu_rhel_92.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 9,2.
