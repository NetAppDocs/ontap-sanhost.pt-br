...
summary: Instale o Linux Host Utilities em um host Oracle Linux 9.2 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configurar o Oracle Linux 9.2 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
O software Utilitários de host Linux fornece ferramentas de gerenciamento e diagnóstico para hosts Linux que estão conetados ao storage ONTAP. Ao instalar o Linux Host Utilities em um host Oracle Linux 9.2, você pode usá-lo para ajudar a gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP.
...
Você pode usar multipathing com o Oracle Linux 9,2 para gerenciar LUNs ONTAP.


NOTE: Você pode usar o link:hu_rhel_92.html#rhel-rhck["configurações recomendadas para Red Hat Enterprise Linux (RHEL) 9.2"] para configurar o Red Hat Compatible Kernel para Oracle Linux 9.2.
...
A versão do Oracle Linux 9.2 com armazenamento ONTAP apresenta os seguintes problemas conhecidos:
