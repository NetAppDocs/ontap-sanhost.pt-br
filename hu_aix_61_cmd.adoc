...
summary: Você pode usar a referência de comando de exemplo de utilitários de host do AIX para uma validação completa da configuração de armazenamento do NetApp usando a ferramenta de utilitários de host. 
---
...
[role="lead"]
Você pode usar a referência de comando de exemplo de utilitários de host do AIX para uma validação completa da configuração de armazenamento do NetApp usando a ferramenta de utilitários de host.
