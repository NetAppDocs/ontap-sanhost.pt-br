...
---
= Use o Veritas Infoscale 7 para Linux com ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Você pode usar as configurações de host SAN ONTAP para a versão da base de armazenamento Veritas Infoscale da série 7 para plataformas Linux e Oracle Linux (baseadas em RHCK) com protocolos FC, FCoE e iSCSI.
...
Não há problemas conhecidos para o Veritas Infoscale 7 para Linux com a versão ONTAP.
