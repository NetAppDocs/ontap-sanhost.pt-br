...
[role="lead"]
Você pode usar as configurações de host SAN ONTAP para a versão da base de armazenamento Veritas Infoscale da série 7 para as plataformas Linux, FCoE e iSCSI.
