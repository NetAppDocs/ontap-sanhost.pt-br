...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 8,6 (RHCK), use o link:hu_rhel_86.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,6.
...
NOTE: Para problemas conhecidos do Oracle Linux RHCK, consulte a link:hu_rhel_86.html#known-problems-and-limitations["problemas conhecidos"]seção na documentação de lançamento correspondente do Red Hat Enterprise Linux.
