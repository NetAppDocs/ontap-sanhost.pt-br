...
summary: Instale os Utilitários de host Linux em um host RHEL 10 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o RHEL 10 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com RHEL 10 para gerenciar LUNs ONTAP.
