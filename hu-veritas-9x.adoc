...
summary: Utilize os utilitários de host Linux com o Veritas Infoscale 9 para hosts RHEL e Oracle Linux para ajudar você a gerenciar operações de protocolo FC, FCoE e iSCSI com LUNs ONTAP . 
---
= Configure o Veritas Infoscale 9 para FC, FCoE e iSCSI com armazenamento ONTAP.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Utilize o Veritas Dynamic Multipathing (VxDMP) com o Veritas Infoscale 9 para gerenciar LUNs ONTAP .
...
----
. Verifique se os parâmetros ajustáveis estão configurados corretamente:
+
[source, cli]
----
# vxdmpadm gettune
