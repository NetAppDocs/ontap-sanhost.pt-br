...
summary: Instale os Utilitários de host Linux em um host RHEL 8,6 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o RHEL 8,6 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com RHEL 8,6 para gerenciar LUNs ONTAP.
