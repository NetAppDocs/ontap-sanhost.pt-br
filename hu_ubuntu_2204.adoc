...
summary: Instale os utilitários do host Linux em um host Ubuntu 22.04 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configurar o Ubuntu 22.04 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
O software Linux Host Utilities fornece ferramentas de gerenciamento e diagnóstico para hosts Linux conectados ao armazenamento ONTAP .  Ao instalar o Linux Host Utilities em um host Ubuntu 22.04, você pode usá-lo para ajudar a gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP .
...
Você pode usar multipathing com o Ubuntu 22.04 para gerenciar LUNs ONTAP .
