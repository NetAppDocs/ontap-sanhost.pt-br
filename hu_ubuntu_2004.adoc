...
summary: Configure o Ubuntu 20.04 para multipathing e com parâmetros e configurações específicos para operação FCP e iSCSI com armazenamento ONTAP . 
---
...
[role="lead"]
Configure o Ubuntu 20.04 para multipathing e com parâmetros e configurações específicos para operação FCP e iSCSI com armazenamento ONTAP .
