...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 8,7 (RHCK), use o link:hu_rhel_87.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,7.
