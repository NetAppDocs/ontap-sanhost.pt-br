...
summary: Instale os utilitários de host Linux em um SUSE Linux Enterprise Server 15 SP6 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configure o SUSE Linux Enterprise Server 15 SP6 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode usar multipathing com o SUSE Linux Enterprise Server 15 SP6 para gerenciar LUNs ONTAP.
