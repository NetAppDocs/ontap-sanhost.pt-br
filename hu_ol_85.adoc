...
summary: Instale o Linux Host Utilities em um host Oracle Linux 8.5 para gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP. 
---
= Configurar o Oracle Linux 8.5 para FCP e iSCSI com armazenamento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
O software Utilitários de host Linux fornece ferramentas de gerenciamento e diagnóstico para hosts Linux que estão conetados ao storage ONTAP. Ao instalar o Linux Host Utilities em um host Oracle Linux 8.5, você pode usá-lo para ajudar a gerenciar operações de protocolo FCP e iSCSI com LUNs ONTAP.
...
Você pode usar multipathing com o Oracle Linux 8,5 para gerenciar LUNs ONTAP.


NOTE: Você pode usar o link:hu_rhel_85.html#rhel-rhck["configurações recomendadas para Red Hat Enterprise Linux (RHEL) 8.5"] para configurar o Red Hat Compatible Kernel para Oracle Linux 8.5.
...
NOTE: Para problemas conhecidos do Oracle Linux RHCK, consulte a link:hu_rhel_85.html#known-problems-and-limitations["problemas conhecidos"]seção na documentação de lançamento correspondente do Red Hat Enterprise Linux.
