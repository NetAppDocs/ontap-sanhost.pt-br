...
---
= Referência de comando Linux Unified Host Utilities 7,1
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Você pode usar a referência de comando de exemplo de utilitários de host unificado Linux 7,1 para uma validação completa da configuração de armazenamento NetApp usando a ferramenta de utilitários de host.
