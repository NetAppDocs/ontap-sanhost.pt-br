...
NOTE: Para configurar o Oracle Linux 8,2 Red Hat Enterprise Kernel (RHCK), use o link:hu_rhel_82.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,2.
...
NOTE: Para problemas conhecidos do Oracle Linux (kernel compatível com Red Hat), consulte o link:hu_rhel_82.html#known-problems-and-limitations["problemas conhecidos"] para Red Hat Enterprise Linux (RHEL) 8,2.
