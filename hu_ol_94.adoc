...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 9,4 (RHCK), use o link:hu_rhel_94.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 9,4.
