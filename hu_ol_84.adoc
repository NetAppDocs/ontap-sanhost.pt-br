...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 8,4 (RHCK), use o link:hu_rhel_84.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,4.
...
NOTE: Para problemas conhecidos do Oracle Linux RHCK, consulte a link:hu_rhel_84.html#known-problems-and-limitations["problemas conhecidos"]seção na documentação de lançamento do RHEL correspondente.
