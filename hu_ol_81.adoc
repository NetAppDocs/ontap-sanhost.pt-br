...
NOTE: Para configurar o kernel compatível com Red Hat do Oracle Linux 8,1 (RHCK), use o link:hu_rhel_81.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,1.
...
NOTE: Para problemas conhecidos do RHCK do Oracle Linux, consulte o link:hu_rhel_81.html#known-problems-and-limitations["problemas conhecidos"] para RHEL 8,1.
