...
summary: Descreve como usar o Oracle Linux 8,1 com ONTAP 
---
= Use o Oracle Linux 8,1 com ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Você pode usar as configurações de host SAN ONTAP para configurar o Oracle Linux 8,1 com ONTAP como destino.
...
Para o Oracle Linux 8,1 o arquivo /etc/multipath.conf deve existir, mas você não precisa fazer alterações específicas no arquivo. O Oracle Linux 8,1 é compilado com todas as configurações necessárias para reconhecer e gerenciar corretamente LUNs ONTAP.
...
O sistema operacional Oracle Linux 8,1 é compilado para reconhecer LUNs ONTAP e definir automaticamente todos os parâmetros de configuração corretamente.
...
NOTE: Para configurar o Oracle Linux 8,1 Red Hat Enterprise Kernel (RHCK), use o link:hu_rhel_81.html#recommended-settings["definições recomendadas"] para Red Hat Enterprise Linux (RHEL) 8,1.



== Problemas conhecidos

Não há problemas conhecidos para o Oracle Linux 8,1 com a versão ONTAP.


NOTE: Para problemas conhecidos do Oracle Linux (kernel compatível com Red Hat), consulte o link:hu_rhel_81.html#known-problems-and-limitations["problemas conhecidos"] para Red Hat Enterprise Linux (RHEL) 8,1.
