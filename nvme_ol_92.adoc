...
--
O driver nativo da caixa de entrada qla2xxx incluído no kernel OL 9,2 GA tem as correções upstream mais recentes. Essas correções são essenciais para o suporte ao ONTAP.
