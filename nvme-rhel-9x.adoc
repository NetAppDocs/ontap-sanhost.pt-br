...
----
. Localize a linha que define iopolicy para o NetApp ONTAP Controller.
+
O exemplo a seguir mostra uma regra de exemplo:
...
NOTE: A nova iopolicy se aplica automaticamente aos dispositivos NetApp ONTAP Controller correspondentes.  Não é necessário reinicializar.
