...
.Alterações na política de E/S para as versões do RHEL 9.x
* A partir do RHEL 9.7, a política de E/S padrão é queue-depth.
* No RHEL 9.6, o round-robin é a iopolicy padrão, mas queue-depth está disponível como uma opção configurável.
* Antes do RHEL 9.6, round-robin era a única política de E/S NVMe-oF suportada.


Se você estiver usando o RHEL 9.6 e quiser alterar a política de E/S para  `queue-depth`, modifique o arquivo de regras do udev da seguinte forma:
